          ...
          <div class="row">
              <div class="col-md-8 border-right">
                  <div class="p-3 py-5">
                      ...
                      <div class="row mt-3">
                          <div class="col-md-6"><label class="labels">Password</label><input type="text" class="form-control" placeholder="Password" name="Password"></div>
                  </div>
                      <div class="mt-5 text-center"><button class="btn btn-primary profile-button" class="button" type="submit">Register</button></div>
                      </form>
                  </div>
              </div>
              </div>
